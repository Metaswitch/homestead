...
`{ "result-code": 2001, "scscf": "<server-name>" [,"wildcard" : "<wildcarded public user identity>"] }`

`{ "result-code": 2001, "mandatory-capabilities": [1,2,3], "optional-capabilities": [4,5,6] [,"wildcard" : "<wildcarded public user identity>"] }`

`{ "result-code": 2001, "mandatory-capabilities": [], "optional-capabilities": [] [,"wildcard" : "<wildcarded public user identity>"] }`
