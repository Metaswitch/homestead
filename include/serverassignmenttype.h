...
{
public:
  ServerAssignmentType(const bool& lookup, const SERVER_ASSIGNMENT_TYPES& type, const bool& dereg) :
  ...
  inline SERVER_ASSIGNMENT_TYPES type() const {return _server_assignment_type;}
...
private:
  bool _cache_lookup;
  SERVER_ASSIGNMENT_TYPES _server_assignment_type;
