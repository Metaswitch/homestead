...
const std::string JSON_REGISTRATIONS = "registrations";
const std::string JSON_PRIMARY_IMPU = "primary-impu";
const std::string JSON_IMPI = "impi";
...
public:
  ...
  virtual HTTPCode send_delete(const bool& send_notifications,
