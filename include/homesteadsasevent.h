...
namespace SASEvent
{
  ...
  const int NO_AV_HSPROV = HOMESTEAD_BASE + 0x0020;
  ...
  const int HSPROV_GET_REG_DATA = HOMESTEAD_BASE + 0x0060;
  const int HSPROV_GET_REG_DATA_SUCCESS = HOMESTEAD_BASE + 0x0061;
  const int HSPROV_GET_REG_DATA_FAIL = HOMESTEAD_BASE + 0x0062;
  ...
  const int ICSCF_NO_HSS_CASSANDRA_SUCCESS = HOMESTEAD_BASE + 0x00A3;
  ...
  const int HSPROV_GET_AV = HOMESTEAD_BASE + 0x0130;
  const int HSPROV_GET_AV_SUCCESS = HOMESTEAD_BASE + 0x0140;
  ...
  const int CACHE_GET_REG_DATA_FAIL = HOMESTEAD_BASE + 0x01B0;
  const int CACHE_GET_REG_DATA_NOT_FOUND = HOMESTEAD_BASE + 0x01B1;
  const int CACHE_PUT_REG_DATA = HOMESTEAD_BASE + 0x01C0;
  const int CACHE_PUT_REG_DATA_IMPI = HOMESTEAD_BASE + 0x01C1;
  const int CACHE_PUT_REG_DATA_SUCCESS = HOMESTEAD_BASE + 0x01C2;
  const int CACHE_PUT_REG_DATA_FAIL = HOMESTEAD_BASE + 0x01C3;
  const int CACHE_DELETE_REG_DATA = HOMESTEAD_BASE + 0x01D0;
  const int CACHE_DELETE_REG_DATA_SUCCESS = HOMESTEAD_BASE + 0x01D1;
  const int CACHE_DELETE_REG_DATA_FAIL = HOMESTEAD_BASE + 0x01D2;
  const int CACHE_DELETE_REG_DATA_NOT_FOUND = HOMESTEAD_BASE + 0x01D3;
